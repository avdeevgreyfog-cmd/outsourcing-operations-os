...
export default async function Assets({searchParams}:{searchParams:Promise<{worker?:string;action?:"issue"|"return";object?:string;view?:"stock"|"norms"}>}){

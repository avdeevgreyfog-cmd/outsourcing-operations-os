...
export default async function StandardsPage() {
  ...
  return <><PageHeader eyebrow="Коммерция → Экономика" title="Нормативы" subtitle="Единый справочник правил, расходов и графиков для воспроизводимых расчётов. Каждая версия привязывается к дате экономики и сохраняется в истории." breadcrumbs={[{label:"Коммерция"},{label:"Экономика"},{label:"Нормативы"}]} /><CalculationStandardsWorkspace models={models} expenses={standards.expenses} schedules={standards.schedules} canManage={hasCapability(actor.access,"calculation.rules.manage")&&!actor.demo} /></>;
}

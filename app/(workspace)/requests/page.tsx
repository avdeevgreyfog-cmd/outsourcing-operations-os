...
export default async function RequestsPage() {
  ...
  return <>
    ...
    <RequestsWorkspaceFinal rows={rows} stages={stages} canCreate={hasCapability(actor.access,"sales.request.create")} canConfigure={options.canConfigurePipeline} canEdit={hasCapability(actor.access,"sales.request.edit")} now={getRequestSnapshotTime()}/>
  </>;
}

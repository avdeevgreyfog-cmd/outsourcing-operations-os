...
export default async function CandidatePage({params}:{params:Promise<{id:string}>}){
  ...
  return <>
    ...
    <CandidateProfileWorkspace profile={profile} candidateId={id} demo={actor.demo} canEdit={actor.demo||hasCapability(actor.access,"recruiting.candidate.edit")} canConvert={actor.demo||hasCapability(actor.access,"recruiting.candidate.convert")}/>
  </>;
}

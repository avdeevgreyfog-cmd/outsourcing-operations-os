...
export default async function CandidatePage({params}:{params:Promise<{id:string}>}){
  ...
  return <>
    ...
    <CandidateProfileWorkspace profile={profile} options={options} needs={needs} candidateId={id} demo={actor.demo} canEdit={hasCapability(actor.access,"recruiting.candidate.edit")} canConvert={hasCapability(actor.access,"recruiting.candidate.convert")}/>
  </>;
}

...
export default async function DepartmentsPage() {
  ...
  return <>
    ...
    <div className="organization-admin-grid">
      <Section title="Изменения структуры" note="Пакет проходит согласование и применяется одной транзакцией"><ChangeSetManager sets={changeSets} units={units} positions={staffPositions} assignments={assignments} canManage={canManage} demo={actor.demo}/></Section>

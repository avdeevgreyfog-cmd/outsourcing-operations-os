...
export const navigationManifest = [
  { id: "home", label: "Главная", icon: "home", groups: [
    ...
    { id: "team-work", label: "Команда", items: [
      ...
      { id: "approvals", label: "Согласования", href: "/approvals", capability: "approval.read" },
    ]},
  ]},
  { id: "commerce", label: "Коммерция", icon: "briefcase", groups: [
    ...
    { id: "economics", label: "Экономика", items: [
      { id: "calculations", label: "К расчёту и расчёты", href: "/calculations", capability: "calculation.scenario.read" },
      { id: "rates", label: "База ставок", href: "/rates", capability: "calculation.rate_reference.read" },
      { id: "standards", label: "Нормативы", href: "/standards", capability: "calculation.rules.read" },
    ]},
    { id: "contracts", label: "Заключение сделки", items: [
      { id: "proposals", label: "Коммерческие предложения", href: "/proposals", capability: "sales.proposal.read", keywords: "кп предложение" },
      { id: "contract-registry", label: "Договоры", href: "/contracts", capability: "contract.read" },
    ]},
  ]},
  ...
  { id: "operations", label: "Операции", icon: "factory", groups: [
    { id: "object-management", label: "Управление объектами", items: [
      { id: "object-registry", label: "Объекты", href: "/objects", capability: "operations.object.read" },
      { id: "launch-plan", label: "План запусков", href: "/launches", capability: "operations.object.read" },
      { id: "staffing-plan", label: "Комплектация", href: "/staffing-plan", capability: "operations.need.read", status: "foundation" },
      { id: "operations-analytics", label: "Аналитика", href: "/operations/analytics", capability: "operations.object.read" },
    ]},
    { id: "operations-workforce", label: "Персонал объектов", items: [
      { id: "workers", label: "Сотрудники", href: "/workers", capability: "worker.read" },
      { id: "crews", label: "Бригады", href: "/crews", capability: "operations.crew.read" },
      { id: "shifts", label: "Графики и смены", href: "/shifts", capability: "operations.shift.read" },
    ...
    { id: "supply", label: "Обеспечение", items: [
      { id: "housing", label: "Жильё", href: "/supply/housing", capability: "supply.housing.read" },
      { id: "assets", label: "Запасы и имущество", href: "/assets", capability: "assets.read" },
      { id: "transport", label: "Транспорт", href: "/supply/transport", capability: "supply.transport.read", status: "foundation" },
      { id: "procurement", label: "Заявки на обеспечение", href: "/procurement", capability: "procurement.read", status: "foundation" },
  ...
  { id: "organization", label: "Организация", icon: "building", groups: [
    { id: "company", label: "Структура", items: [
      { id: "org-structure", label: "Оргструктура", href: "/organization/structure", capability: "organization.read" },
      { id: "company-staff", label: "Сотрудники компании", href: "/organization/staff", capability: "organization.read" },
      { id: "positions", label: "Должности и роли", href: "/organization/positions", capability: "organization.read" },
      { id: "departments", label: "Подразделения и регионы", href: "/organization/departments", capability: "organization.read" },
    ]},

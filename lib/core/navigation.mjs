...
export const navigationManifest = [
  ...
  { id: "operations", label: "Операции", icon: "factory", groups: [
    { id: "object-management", label: "Управление объектами", items: [
      ...
      { id: "staffing-plan", label: "План комплектации", href: "/staffing-plan", capability: "operations.need.read" },
      { id: "operations-analytics", label: "Аналитика объектов", href: "/operations/analytics", capability: "operations.object.read" },
    ]},

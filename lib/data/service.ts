...
export type LaunchTaskRow = ScopedRow & { id:string; launchId?:string|null; objectId:string; object:string; title:string; level:number; owner:string; start:string; end:string; baselineStart?:string|null; baselineEnd?:string|null; progress:number; status:string; risk:string; milestone:boolean; critical:boolean; dependencyIds:string[]; launchTarget?:string|null; launchForecast?:string|null; launchProgress?:number|null; launchRisk?:string|null };

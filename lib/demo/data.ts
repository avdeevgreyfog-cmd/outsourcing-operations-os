...
export const needs = [
 {id:"83000000-0000-4000-8000-000000000001",organizationId:ORG,objectId:objects[0].id,object:"РЦ Север",clientId:clients[0].id,regionId:MOW,specialty:"Комплектовщик",required:24,filled:17,deficit:7,deadline:"10.09",status:"open",ownerUserId:recruiter,createdByUserId:objectManager,assigneeUserIds:[recruiter,objectManager,regional],conditions:{workerPay:"130 000 ₽/мес",dailyAllowanceProvided:true,dailyAllowanceAmount:"1 000 ₽/день",schedule:"6/1 · 11 оплачиваемых часов",shift:"08:00–20:00",location:"Москва, Дмитровское шоссе",housingProvided:true,housing:"Общежитие рядом с объектом",travelProvided:true,travel:"Билеты до Москвы компенсирует компания",shuttleProvided:true,shuttle:"Корпоративный автобус от общежития",mealsProvided:false,meals:"Столовая на территории, питание за свой счёт",ppeProvided:true,ppe:"Комплект спецодежды и обувь",medicalProvided:true,medical:"Медосмотр организует компания",toolsProvided:true,tools:"Рабочий инвентарь выдаётся на объекте",citizenship:"РФ / РБ",requirements:"Готовность к физической работе, опыт не обязателен",comment:"Основной приоритет — комплектовка дневной смены"}},
 {id:"83000000-0000-4000-8000-000000000002",organizationId:ORG,objectId:objects[0].id,object:"РЦ Север",clientId:clients[0].id,regionId:MOW,specialty:"Грузчик",required:8,filled:5,deficit:3,deadline:"10.09",status:"open",ownerUserId:recruiter,createdByUserId:objectManager,assigneeUserIds:[recruiter,objectManager,regional],conditions:{workerPay:"120 000 ₽/мес",dailyAllowanceProvided:true,dailyAllowanceAmount:"700 ₽/день",schedule:"6/1 · 11 оплачиваемых часов",shift:"08:00–20:00",location:"Москва, Дмитровское шоссе",housingProvided:true,housing:"Общежитие рядом с объектом",travelProvided:true,travel:"Проезд до Москвы компенсируется после выхода",shuttleProvided:true,shuttle:"Развозка от общежития",mealsProvided:false,meals:"На объекте есть столовая",ppeProvided:true,ppe:"Спецодежда предоставляется",medicalProvided:true,medical:"Предварительный медосмотр за счёт компании",toolsProvided:true,tools:"Инвентарь объекта",citizenship:"РФ / РБ",requirements:"Физическая выносливость",comment:"Нужны люди на дневные и ночные смены"}},

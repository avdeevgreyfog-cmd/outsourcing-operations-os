...
export const organizationUnits: OrganizationUnitRow[] = [
  {id:unitId(1),organizationId:ORG,parentId:null,regionId:null,region:null,code:"company",name:"БЕТА · ОПЕРИС Аутсорсинг",kind:"company",description:"Тестовая рабочая модель компании для сквозной проверки OPERIS",active:true,sortOrder:0,employeeCount:13,staffPositionCount:13,vacancyCount:0,childCount:6,managerMembershipId:membershipId(1),manager:"Анна Лебедева"},
  ...
  {id:unitId(5),organizationId:ORG,parentId:unitId(1),regionId:null,region:null,code:"operations",name:"Операции",kind:"department",description:"Управление портфелем объектов и производственным персоналом",active:true,sortOrder:30,employeeCount:1,staffPositionCount:1,vacancyCount:0,childCount:1,managerMembershipId:membershipId(3),manager:"Алексей Громов"},
  ...
  {id:unitId(7),organizationId:ORG,parentId:unitId(1),regionId:null,region:null,code:"supply",name:"Обеспечение",kind:"department",description:"Снабжение, имущество, жильё и операционный документооборот",active:true,sortOrder:45,employeeCount:1,staffPositionCount:1,vacancyCount:0,childCount:0,managerMembershipId:membershipId(11),manager:"Ирина Белова"},
  ...
  {id:unitId(10),organizationId:ORG,parentId:unitId(1),regionId:null,region:null,code:"finance",name:"Экономика и финансы",kind:"department",description:"Расчёты, начисления, выплаты и фактическая экономика объектов",active:true,sortOrder:50,employeeCount:1,staffPositionCount:1,vacancyCount:0,childCount:0,managerMembershipId:membershipId(6),manager:"Елена Котова"},
];
...
export const positions: PositionRow[] = [
  ...
  {id:positionId(9),organizationId:ORG,code:"finance-economist",name:"Экономист / финансовый менеджер",purpose:"Вести коммерческую и фактическую экономику компании",duties:["Готовить расчёты","Проверять маржинальность","Вести нормативы и базу ставок","Проверять начисления и выплаты","Сверять табели","Анализировать P&L"],responsibilities:["Расчёты и ставки","Маржа","Начисления и выплаты","Финансовый результат"],processes:["Расчёт экономики","Согласование","Закрытие периода","Выплаты","P&L"],active:true,employeeCount:1,capabilityCount:18},
];
...
export const companyEmployees: CompanyEmployeeRow[] = [
  ...
  {id:membershipId(6),userId:userId(6),organizationId:ORG,name:"Елена Котова",email:"economist@beta.local",phone:"+7 900 200-06-06",status:"active",positionId:positions[8].id,position:positions[8].name,orgUnitId:unitId(10),orgUnit:"Экономика и финансы",regionId:null,region:null,managerMembershipId:membershipId(1),manager:"Анна Лебедева",roles:[role(8),role(9)],responsibilities:["Коммерческие расчёты и база ставок","Контроль плановой маржи","Начисления и выплаты","Закрытие табелей","Фактический P&L"],primaryStaffPositionId:staffPositionId(13),primaryStaffPosition:"Экономист / финансовый менеджер",additionalAssignments:0,objectCount:5},
  ...
  {id:membershipId(11),userId:userId(11),organizationId:ORG,name:"Ирина Белова",email:"supply@beta.local",phone:"+7 900 200-11-11",status:"active",positionId:positions[5].id,position:positions[5].name,orgUnitId:unitId(7),orgUnit:"Обеспечение",regionId:null,region:null,managerMembershipId:membershipId(1),manager:"Анна Лебедева",roles:[role(5)],responsibilities:["Запасы и имущество","Заявки на обеспечение","Жильё и поставщики","Операционный документооборот"],primaryStaffPositionId:staffPositionId(8),primaryStaffPosition:"Специалист по снабжению и документообороту",additionalAssignments:0,objectCount:5},
...
export const staffPositions: StaffPositionRow[] = [
  ...
  seat(8,"SUPPLY-01","Специалист по снабжению и документообороту",6,7,1,"Генеральный директор / собственник",1),
  ...
  seat(13,"FIN-ECON-01","Экономист / финансовый менеджер",9,10,1,"Генеральный директор / собственник",1),
];

...
const ALL = [
  ...
  "finance.worker_accrual.read","finance.worker_accrual.edit","finance.payments.read","finance.payments.edit","finance.daily_payment.confirm","finance.object_payment.record","finance.client_margin.read","finance.pnl.read",

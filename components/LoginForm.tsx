...
export function LoginForm({ demo }: { demo: boolean }) {
  ...
  function demoLogin(role:string){setBusy(true);document.cookie=`oo_demo_role=${encodeURIComponent(role)}; Path=/; Max-Age=2592000; SameSite=Lax`;router.push("/");router.refresh();}

...
const statusLabels:Record<string,string>={
  active:"Активен",suspended:"Приостановлен",invited:"Приглашён",open:"Открыто",launch:"Запуск",accepted:"Принято",draft:"Черновик",
  ...
  critical:"Критический",high:"Высокий",medium:"Средний",low:"Низкий",watch:"Наблюдение",normal:"Норма",risk:"Есть риск",closed:"Закрыто",
  ...
  documents:"Документы",first_shift:"Первый выход",rejected:"Отклонено",verified:"Проверено",pending:"Ожидает",submitted:"Отправлено",confirmed:"Подтверждено",demo:"Демонстрация",preview:"Предпросмотр"
};

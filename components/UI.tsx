...
const statusLabels:Record<string,string>={
  active:"Активен",suspended:"Приостановлен",invited:"Приглашён",open:"Открыто",launch:"Запуск",prelaunch:"Подготовка к запуску",accepted:"Принято",draft:"Черновик",
  review:"На проверке",calculated:"Рассчитано",calculation:"Расчёт",calculation_review:"Расчёт на согласовании",proposal_ready:"Готово к КП",
  proposal_draft:"Черновик КП",proposal_review:"КП на согласовании",proposal:"КП согласовано",proposal_sent:"КП отправлено",negotiation:"Переговоры",
  internal_review:"На внутреннем согласовании",sent:"Отправлено клиенту",revision_requested:"Требуется пересчёт",client_rejected:"Клиент отказался",
  rejected_internal:"Не согласовано внутри",superseded:"Заменено новой версией",launched:"Передано в запуск",lost:"Проиграно",archived:"Архив",
  critical:"Критический",high:"Высокий",medium:"Средний",low:"Низкий",watch:"Наблюдение",normal:"Норма",risk:"Есть риск",closed:"Закрыто",filled:"Закрыта",cancelled:"Отменена",
  approved:"Согласовано",planned:"Запланировано",in_progress:"В работе",done:"Выполнено",paid:"Выплачено",resolved:"Разрешено",new:"Новый",call:"Созвон",
  contact:"Контакт",interview:"Интервью",manager_review:"На согласовании",preparation:"Подготовка",ready:"Готов к выходу",started:"Вышел",no_show:"Не вышел",
  documents:"Документы",first_shift:"Первый выход",rejected:"Отклонено",verified:"Проверено",pending:"Ожидает",submitted:"Отправлено",confirmed:"Подтверждено",demo:"Демонстрация",preview:"Предпросмотр",worker:"Сотрудник"
};

...
import type { CompanyEmployeeRow, PositionAssignmentRow, PositionRow, ProcessRoleRow, ResponsibilityRuleRow, StaffPositionRow } from "@/lib/organization/types";
...
export function PositionCatalog({profiles,staffPositions,assignments,roles,responsibilities,employees,canManage,demo}:{profiles:PositionRow[];staffPositions:StaffPositionRow[];assignments:PositionAssignmentRow[];roles:ProcessRoleRow[];responsibilities:ResponsibilityRuleRow[];employees:CompanyEmployeeRow[];canManage:boolean;demo:boolean}){

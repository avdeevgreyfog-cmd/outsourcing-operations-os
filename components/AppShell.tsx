...
const navigation: NavigationSection[] = [
  ...
  { id: "finance", label: "Финансы", icon: "wallet", groups: [{ id: "object-economics", label: "Экономика объектов", items: [{ label: "P&L", href: "/finance", capability: "finance.pnl.read" }, { label: "Сравнение объектов", href: "/analytics?view=comparison", capability: "analytics.portfolio.read" }] }]},
  { id: "analytics", label: "Аналитика", icon: "chart", groups: [{ id: "analytics-main", label: "Отчёты", items: [{ label: "Портфель", href: "/analytics", capability: "analytics.portfolio.read" }, { label: "Подбор и workforce", href: "/analytics?view=workforce", capability: "analytics.portfolio.read" }] }]},
  { id: "control", label: "Контроль", icon: "shield", groups: [{ id: "control-main", label: "Рабочий контроль", items: [{ label: "Задачи", href: "/tasks", capability: "task.read" }, { label: "Activity", href: "/activity", capability: "home.command.read" }, { label: "Инциденты", href: "/incidents", capability: "operations.object.read" }, { label: "Compliance", href: "/compliance", capability: "worker.read" }] }]},

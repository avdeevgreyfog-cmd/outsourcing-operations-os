...
BEGIN
  ...
  INSERT INTO contacts(
    ...
    ('8d000000-0000-4000-8000-000000000006',org_id,'70000000-0000-4000-8000-000000000001','Ольга Демина','Бухгалтер по первичным документам','+7 900 555-01-06','o.demina@example.ru',NULL,NULL,NULL,'email','10000000-0000-4000-8000-000000000008','10000000-0000-4000-8000-000000000008'),
    ('8d000000-0000-4000-8000-000000000007',org_id,'70000000-0000-4000-8000-000000000002','Наталья Орехова','Специалист по документообороту','+7 900 555-02-07','n.orekhova@example.ru','@orekhova_docs',NULL,NULL,'telegram','10000000-0000-4000-8000-000000000009','10000000-0000-4000-8000-000000000009'),
    ('8d000000-0000-4000-8000-000000000008',org_id,'70000000-0000-4000-8000-000000000003','Роман Лыткин','Инженер по охране труда','+7 900 555-03-08','r.lytkin@example.ru',NULL,'+7 900 555-03-08',NULL,'whatsapp','10000000-0000-4000-8000-000000000008','10000000-0000-4000-8000-000000000008'),
    ('8d000000-0000-4000-8000-000000000009',org_id,'70000000-0000-4000-8000-000000000004','Виктория Громова','Координатор подрядчиков','+7 900 555-04-09','v.gromova@example.ru','@gromova_market',NULL,NULL,'telegram','10000000-0000-4000-8000-000000000009','10000000-0000-4000-8000-000000000009'),
    ('8d000000-0000-4000-8000-000000000010',org_id,'70000000-0000-4000-8000-000000000005','Сергей Власов','Финансовый контролёр','+7 900 555-05-10','s.vlasov@example.ru',NULL,NULL,NULL,'email','10000000-0000-4000-8000-000000000008','10000000-0000-4000-8000-000000000008')
  ON CONFLICT(id) DO UPDATE SET
  ...
  INSERT INTO object_contact_assignments(
    ...
    ('8e000000-0000-4000-8000-000000000006',org_id,'80000000-0000-4000-8000-000000000001','8d000000-0000-4000-8000-000000000006',ARRAY['finance','closing_signer'],'Сверка закрывающих документов и первички',true,'10000000-0000-4000-8000-000000000004'),
    ('8e000000-0000-4000-8000-000000000007',org_id,'80000000-0000-4000-8000-000000000002','8d000000-0000-4000-8000-000000000007',ARRAY['documents','approval'],'Документы и согласования по персоналу',true,'10000000-0000-4000-8000-000000000010'),
    ('8e000000-0000-4000-8000-000000000008',org_id,'80000000-0000-4000-8000-000000000003','8d000000-0000-4000-8000-000000000008',ARRAY['security','warehouse_ppe'],'Охрана труда, СИЗ и допуски',true,'10000000-0000-4000-8000-000000000010'),
    ('8e000000-0000-4000-8000-000000000009',org_id,'80000000-0000-4000-8000-000000000004','8d000000-0000-4000-8000-000000000009',ARRAY['approval','documents'],'Координация подрядчиков и согласования',true,'10000000-0000-4000-8000-000000000004'),
    ('8e000000-0000-4000-8000-000000000010',org_id,'80000000-0000-4000-8000-000000000005','8d000000-0000-4000-8000-000000000010',ARRAY['finance','closing_signer'],'Финансовая сверка и закрывающие документы',true,'10000000-0000-4000-8000-000000000004')

...
function horizontal() {
  const body = `<g>${line(530, 480, 620, 480, C.accent, 2)}${line(620, 405, 620, 660, C.borderStrong, 1.5)}${line(620, 405, 690, 405)}${line(620, 490, 690, 490)}${line(620, 575, 690, 575)}${line(620, 660, 690, 660)}
  ${node(300, 426, 230, 108, "Компания", "ООО «ОПЕРИС»", "С. Петров", "46 сотрудников", "root")}
  ${node(690, 350, 290, 110, "Коммерция", "Продажи", "И. Петров", "12 сотрудников · 1 вакансия", "region")}${node(690, 435, 290, 110, "Операции", "Производство", "М. Иванова", "21 сотрудник · 3 вакансии", "region")}${node(690, 520, 290, 110, "Люди", "Подбор и персонал", "Не назначен", "8 сотрудников · 1 вакансия", "region")}${node(690, 605, 290, 110, "Финансы", "Финансовый контур", "Е. Орлова", "5 сотрудников", "region")}
  ${line(980, 405, 1045, 405)}${line(1045, 380, 1045, 430)}${line(1045, 380, 1110, 380)}${line(1045, 430, 1110, 430)}${node(1110, 337, 300, 86, "Команда", "Клиентский отдел", "А. Смирнов", "6 сотрудников", "unit")}${node(1110, 387, 300, 86, "Команда", "Расчёты и КП", "Е. Орлова", "6 сотрудников", "unit")}
  ${line(980, 490, 1045, 490)}${line(1045, 490, 1110, 490)}${node(1110, 447, 300, 86, "Команда", "Запуски объектов", "Д. Ким", "13 сотрудников", "unit")}
